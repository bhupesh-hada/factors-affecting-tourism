# -*- coding: utf-8 -*-
"""
Created on Wed Mar  7 04:01:58 2018
...
b=[]
import codecs
with codecs.open('actual_statement_conveyance.txt', "r",encoding='utf-8', errors='ignore') as fdata:
    c=fdata.readlines()
...
abc=corpus+final_list_conveyance
...
df_final=pd.DataFrame({'Review':actual_statement_conveyance,'Rating':y_pred},columns=['Review','Rating'])
df_final.to_csv('conveyance_Rajasthan_3.csv')
