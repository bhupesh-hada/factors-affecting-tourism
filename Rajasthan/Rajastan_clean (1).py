...
with codecs.open('clean_Uttar_Pradesh.txt', "r",encoding='utf-8', errors='ignore') as fdata:
    c01=fdata.readlines()
...
abc=corpus+final_list_clean1_Rajasthan
...
df_final=pd.DataFrame({'Review':actual_statement_clean_Rajasthan,'Rating':y_pred},columns=['Review','Rating'])
  
df_final.to_csv('clean_Rajasthan_6.csv')