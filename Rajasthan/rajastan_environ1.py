# -*- coding: utf-8 -*-
"""
Created on Sat Feb 10 19:45:33 2018
...
b=[]
import codecs
with codecs.open('actual_environment.txt', "r",encoding='utf-8', errors='ignore') as fdata:
    c=fdata.readlines()
...
#importing the Blogs
import os
os.chdir('C:/Users/bhupe/Desktop/Factors affecting Tourism/Rajasthan')



import codecs
with codecs.open('Rajasthan.csv', "r",encoding='utf-8', errors='ignore') as fdata:
    c1=fdata.readlines()
    
    
    
    
with codecs.open('Rajasthan_1.csv', "r",encoding='utf-8', errors='ignore') as fdata:
    c2=fdata.readlines() 
    
with codecs.open('Rajasthan_2.csv', "r",encoding='utf-8', errors='ignore') as fdata:
    c3=fdata.readlines()     
...
final_list_environment1_Rajasthan=[]
...
for i in range(0,len(s)):
    ...
    for j in range(len(corpus_environment)):
        if corpus_environment[j] in wr_br:
            ...
            final_list_environment1_Rajasthan.append(statement)
            break    
         
actual_statement_environ1_Rajasthan=[]
for i in index_environ1:
    actual_statement_environ1_Rajasthan.append(df[0][i])               
    
  
    
    
    
abc=corpus+final_list_environment1_Rajasthan
...
df=pd.DataFrame({'Review':actual_statement_environ1_Rajasthan,'Rating':y_pred},columns=['Review','Rating'])
df.to_csv('environment_Rajasthan_3.csv')
