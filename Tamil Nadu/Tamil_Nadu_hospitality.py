# -*- coding: utf-8 -*-
"""
Created on Wed Mar  7 00:49:31 2018
...
df_final=pd.DataFrame({'Review':actual_statement_hospitality,'Rating':y_pred},columns=['Review','Rating'])
df_final.to_csv('hospitality_Tamil_Nadu_3.csv')
